...
<div className="card border border-5" id="pass" style={{width: "28rem",height:"38rem",position:"absolute",top:"90%",left:"50%",transform: 'translate(-50%, 50%)'}}>
    <img src="https://media.istockphoto.com/id/1500914761/vector/fitness-health-gym-trendy-icons-on-circles.jpg?s=612x612&w=0&k=20&c=MaSBJ-edgZ2Nm7utjZgYupCWAzhrcIek0Udz48L_JME=" alt="img1" style={{width:'100px',height:'100px',margin:'auto'}}/>
<p className="card-text " id="pass1">You forgot your password?Here you can easily retrieve a new password.</p>
  ...
  <button className="btn btn-primary" type="button" onClick={handleResetRequest}>Request new password</button>
  <div>or</div>
