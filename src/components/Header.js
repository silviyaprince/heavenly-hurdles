        ...
        <div className="lg:p-3  flex flex-row lg:flex-1 bg-primary2 h-24 lg:h-32    lg:gap-3 lg:justify-evenly justify-around  ">
          <Popover className="lg:hidden relative z-50">
            <PopoverButton className="inline-flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900">
              <IoMdMenu
                onClick={() => setisFlyoutmenuopen(!isFlyoutmenuopen)}
                className="block lg:hidden text-4xl text-white mt-6 ml-2"
              />
            </PopoverButton>
          ...
          <div className="flex flex-row justify-center ">
            <img
              className="w-[200px] h-auto bg-slate-400 mr-5 mt-2"
              src={PigeonLogo}
              alt="company logo"
            />
            <img
          ...
          <h2  className="text-white text-xl xl:text-3xl mt-7 md:text-xl mr-10 font-script text-white  mt-7">
            Rise Above. Run Beyond.
          </h2>{" "}
